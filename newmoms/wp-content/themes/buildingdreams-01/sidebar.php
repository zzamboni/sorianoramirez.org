	<div id="sidebar">
      ...
      <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		 ...
		 <?php /* If this is a monthly archive */ } elseif (is_search()) { ?>
			...
			<p>You are currently in the NewMoms forums. 
			<a href="/">Click here to go back to NewMoms.</a></p>
			<?php } ?>
			...
			<li><h2>Categories</h2>
				<ul>
				<?php wp_list_cats('sort_column=ID&optioncount=1&hierarchical=1'); ?>
				</ul>
			</li>
